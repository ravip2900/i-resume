...
const Left = () => {
    return (
        <LeftContainer>
            <Typography variant="h5" component="h5">BEDUDURI MADHAN KUMAR</Typography>
            <Typography variant="h6" component="h6">Senior Frontend Developer</Typography>
            <p><Location className='icon' />Nellore, Andhrapradesh</p>
            <p><Phone className='icon' />+91 9494141260</p>
            <p><Email className='icon' />madhaniiit@gmail.com</p>
            {/* <p>
