...
const Left = () => {
    return (
        <LeftContainer>
            ...
            <Typography variant="h6" component="h6">Lead Software Engineer</Typography>
            <p><Location className='icon' />Bengaluru</p>
            ...
            <p>
                <Code className='icon' />
                <Link href='https://leetcode.com/u/ravip2900'>https://leetcode.com/u/ravip2900</Link>
            </p>
            <section>
            ...
            <section>
                <Typography variant="h6" component="h6">
                    <Psychology className='icon icon2' />AI &amp; Tools
                </Typography>
                <ul>
                    <li>Windsurf</li>
                    <li>CodeX</li>
